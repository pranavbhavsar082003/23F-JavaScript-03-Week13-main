...
function success(position) {
    ...
    mapLink.setAttribute("href", url); // <a id="mapLink" href="https://www.openstreetmap.org/#map=16/44.4115/-79.6575"></a>
    mapLink.setAttribute("target", "_blank"); // <a id="mapLink" target="_blank" href="https://www.openstreetmap.org/#map=16/44.4115/-79.6575"></a>
...
function error() {
    ...
    statusMsg.textContent = "Position not found!";
}
