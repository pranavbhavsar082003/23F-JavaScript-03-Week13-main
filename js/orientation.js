...
function error() {
    ...
    alert("Device orientation API is not supported by your device!");
}
...
if (!window.DeviceOrientationEvent) {
    ...
    // STEP 3a: Build an event listener for the 'deviceorientation' event, 
    // and build out an anonymous callback function, passing in the event itself
